...
public class HelloController {
    ...
    //****************************************
    //              Word B
    private int xSpinPointB; private int ySpinPointB; @FXML private Circle pointSpinK;
    ...
    private void initB() {
        ...
        xSpinPointB = (int) pointSpinK.getCenterX();
        ySpinPointB = (int) pointSpinK.getCenterY();
        ...
        fillColorPickerK.setValue(Color.rgb(64, 79, 194));
        lineColorPickerK.setValue(Color.WHITE);
        spinColorPickerK.setValue(Color.YELLOW);
    ...
    private void redrawK() {
        ...
        if (pointsWithinBounds) pointsK = rotate(pointsK, tempPoints, cosAngle, sinAngle, xSpinPointB, ySpinPointB);
    ...
    private void redrawY() {
        ...
        boolean pointsWithinBounds = Arrays.stream(tempPoints).noneMatch(point -> point[0] < minX || point[0] > maxX || point[1] < minY || point[1] > maxY);
        if (pointsWithinBounds) pointsY = rotate(pointsY, tempPoints, cosAngle, sinAngle, xSpinPointB, ySpinPointB);
    ...
    private void initV() {
        xPointK.valueProperty().addListener((observable, oldValue, newValue) -> redrawV());
        yPointK.valueProperty().addListener((observable, oldValue, newValue) -> redrawV());
        spinPointSliderK.valueProperty().addListener((observable, oldValue, newValue) -> redrawV());
        ...
        widthSliderK.valueProperty().addListener((observable, oldValue, newValue) -> redrawV());
        redrawV();
    }
    private void redrawV() {
        ...
        boolean pointsWithinBounds = Arrays.stream(tempPoints).noneMatch(point -> point[0] < minX || point[0] > maxX || point[1] < minY || point[1] > maxY);
        if (pointsWithinBounds) pointsB = rotate(pointsB, tempPoints, cosAngle, sinAngle, xSpinPointB, ySpinPointB);
    ...
    private void init0() {
        ...
        fillColorPicker0.setValue(Color.rgb(64, 79, 194));
        lineColorPicker0.setValue(Color.WHITE);
        spinColorPicker0.setValue(Color.YELLOW);
    ...
    private void redraw6() {
        ...
        double[][] tempPoints = new double[][]{
                {(initialY ) * yK, (initialX) * xK},
                {(initialY + 5) * yK, (initialX) * xK},
                {(initialY + 5) * yK, (initialX + 10) * xK},
                {(initialY + 0) * yK, (initialX + 10) * xK},
                {(initialY + 0) * yK, (initialX + 8) * xK},
                {(initialY + 3) * yK, (initialX + 8) * xK},
                {(initialY + 3) * yK, (initialX + 6) * xK},
                {(initialY + 0) * yK, (initialX + 6) * xK},
                {(initialY + 0) * yK, (initialX + 4) * xK},
                {(initialY + 3) * yK, (initialX + 4) * xK},
                {(initialY + 3) * yK, (initialX + 2) * xK},
                {(initialY) * yK, (initialX + 2) * xK},
                {(initialY + 0) * yK, (initialX) * xK},
        };
